...
const ShowSelectedLifePhase : React.FC<ShowSelectedLifePhaseProps>= ({t}) => {
     ...
     */
    const getIncome = () => {
        return selectedLifePhase.income ? selectedLifePhase.income.getTotalIncome() : 0;
    }
     ...
     */
    const getExpenses = () => {
        return selectedLifePhase.expenses ? selectedLifePhase.expenses.getTotalExpenses() : 0;
    }
