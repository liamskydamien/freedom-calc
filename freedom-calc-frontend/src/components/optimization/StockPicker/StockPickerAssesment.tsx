...
const StockPickerAssesment = () => {
  const { selectedStocks, notSelectedStocks, addStock, removeStock } =
    useContext(SelectedStocksContext);
    ...
    <div className="max-w-2xl min-w-2xl">
      ...
      <div className="accordion">
        ...
        <label htmlFor="toggle-15" className="accordion-title ml-2">
          <h2 className="text-lg">{t("add_more_stocks")}</h2>
          <span className="text-sm text-content3 font-normal">
            {t("select_atleast_10_stocks")}
          </span>
        </label>
