    ...
    return (
        <div className="card max-w-full p-5">
            ...
            <div className="tabs">
                ...
                <label htmlFor="tab-9" className="tab tab-bordered px-6">{t('pof_per_portfolio')}</label>

                <input type="radio" id="tab-10" name="tab-2" className="tab-toggle" onClick={() => {setActiveTab(1)}}/>
                <label htmlFor="tab-10" className="tab tab-bordered px-6">{t('portfolio_comparison')}</label>
            </div>
            {
