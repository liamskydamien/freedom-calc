...
export const ProgressContext = createContext({progress: new Progress(), updateProgress: (progress: Progress) => {}});
...
const ProgressContextProvider: React.FC<ProgressProviderProps> = ({children}) => {
