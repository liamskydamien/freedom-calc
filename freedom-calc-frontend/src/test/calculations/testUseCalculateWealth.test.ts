import {
  ...
  useCalculateWealth,
} from "../../calculations/useCalculateWealth";
...
describe("testing useCalculateWealth", () => {
  ...
  const INVESTMENT_WEIGHTS: InvestmentWeights = new InvestmentWeights(
    0.2,
    0.2,
    0.2,
    0.2,
...
describe("testing calculateIncreasePerAssetGroup", () => {
  ...
  test("calculateIncreasePerAssetGroup (positive)", () => {
    /* Define the expected result */
    const expectedResult: number[] = [10700, 11635, 12817];
